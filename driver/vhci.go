...
func (d *VHCIDriver) describeUsbFromBusId(busId string) (*USBIPDeviceDescription, error) {
...
func (d *VHCIDriver) updateDevicesFromControllerStatus(statusContent string) error {
...
func (d *VHCIDriver) UpdateAttachedDevices() error {
	var i uint
...
func (d *VHCIDriver) GetFreePort(speed USBDeviceSpeed) (VirtualPort, error) {
...
func (d *VHCIDriver) AttachDevice(conn *net.TCPConn, deviceId uint32, speed USBDeviceSpeed) (VirtualPort, error) {
...
func (d *VHCIDriver) doAttachDevice(port VirtualPort, fd uint, deviceId uint32, speed USBDeviceSpeed) error {
...
func (d *VHCIDriver) DetachDevice(port VirtualPort) error {
